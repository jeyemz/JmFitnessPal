...
const AdminHeader = ({ title, subtitle, onPrimaryButtonClick, primaryButtonText, showSearchBar = true, searchPlaceholder = "Search reports or data..." }) => {
  const adminUser = { name: 'No admin', role: 'Role', avatar: '' };
      ...
      React.createElement("div", { className: "flex items-center space-x-4" },
        ...
        React.createElement("div", { className: "flex items-center space-x-2" },
          React.createElement("div", { className: "text-right" },
            React.createElement("p", { className: "text-sm font-semibold text-gray-900" }, adminUser.name),
            React.createElement("p", { className: "text-xs text-gray-500" }, adminUser.role)
          ),
          adminUser.avatar ? (
            ...
            React.createElement("div", { className: "w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center text-gray-400 text-xs", "aria-label": "Admin Avatar" }, "—")
          )
        ),
